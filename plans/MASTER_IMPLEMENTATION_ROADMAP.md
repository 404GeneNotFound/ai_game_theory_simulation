...
**Date:** November 17, 2025 (Updated: End of Marcus 2.0 Planning Session)
**Purpose:** Central hub linking to all specialized roadmaps
**Philosophy:** Research-backed realism, mechanism-driven emergence

**Current Status:** 🟢 **STABLE** (Nov 17, 2025 - Post-planning session)
...
- ✅ **RESEARCH PLATFORM: Marcus 2.0 Planning & Nested Learning Validation** (Nov 17, 2025)
  - **Scope:** Agent-based platform engineering behavior modeling using nested learning framework
  - **Testing:** ✅ Both nested learning implementations validated (enhanced + citation study versions)
  - **Planning:** ✅ 5 iterations converged to final plan (4 intermediate plans archived)
  - **Focus:** Code attribution patterns (proper credit → copy-paste → claiming originality), knowledge transfer dynamics, technical debt accumulation
  - **Innovation:** Multi-level memory system (Fast/Medium/Slow timescales), context-aware pheromones (deadline pressure, visibility, culture)

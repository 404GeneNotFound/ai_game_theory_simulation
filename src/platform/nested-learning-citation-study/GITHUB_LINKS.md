# GitHub Links - Nested Learning Citation Study Platform
...
If you need to download files directly:
...
https://github.com/404GeneNotFound/ai_game_theory_simulation/commit/b3cddb09

**Complete Implementation Added**
https://github.com/404GeneNotFound/ai_game_theory_simulation/commit/31045cdf

**Integration Bridge Added**
https://github.com/404GeneNotFound/ai_game_theory_simulation/commit/5ec18fdf
...
1. Start with PLATFORM_OVERVIEW.md (big picture)
2. Then README.md (quick start)
3. Then integration/README.md (if using TypeScript integration)
4. Finally COMPLETE_AGENT_DOCUMENTATION.md (full architecture)

### For Coding:
1. Review nested_learning_enhanced.py (see the implementation)
2. Check integration/citation_integrity_agent.py (production agent)
3. Review integration/citationAgentIntegration.ts (TypeScript bridge)
4. Check docs/citations_and_integration.md (theory)

### For Understanding Decisions:
1. Read analysis/branch_comparison.md (why both systems)
2. Read analysis/code_comparison_analysis.md (implementation trade-offs)
3. Review docs/citations_and_integration.md (academic grounding)
